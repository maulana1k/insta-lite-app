...
import { ArrowUp, Globe, Lock, ShieldCheck, KeyRound, MoreHorizontal, Plus, AtSign, Check } from 'lucide-react';
    ...
    <div className="space-y-12">
        ...
        <div className="flex gap-8 items-start">
          <div className="flex-1 min-w-0 space-y-5">
            ...
            <div className="space-y-2">
              <label className="text-[13px] font-semibold text-muted-foreground">Nama Depan</label>
              <input
                type="text"
                value={nameForm.displayName}
                onChange={(e) => setNameForm({ ...nameForm, displayName: e.target.value })}
                className={cn(
            ...
            <div className="space-y-1">
              <label className="text-[13px] font-semibold text-muted-foreground">Username</label>
            ...
            {/* Website */}
            <div className="space-y-2">
              <label className="text-[13px] font-semibold text-muted-foreground">Website</label>
        ...
        <div className="rounded-2xl border border-border bg-muted/20 px-4 py-3.5 flex items-start justify-between gap-3">
          <div>
            <div className="flex items-center gap-2 mb-0.5">
              <span className="text-[14px] font-medium">jack.harding@example.com</span>
              <Badge variant="secondary" className="text-[11px] px-1.5 py-0">Utama</Badge>
            </div>
            <p className="text-[12px] text-muted-foreground">
              Email ini akan dibagikan kepada pengguna lain saat Anda berinteraksi.
            </p>
          </div>
      ...
      <section>
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-[12px] text-muted-foreground">
            Demi keamanan Anda, kami akan mengirimkan kode untuk memverifikasi perubahan nomor telepon.
          </p>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="rounded-2xl border border-border divide-y divide-border overflow-hidden">
            ...
            action={
              <AlertDialog>
                ...
                <AlertDialogContent>
                  ...
                  <AlertDialogFooter>
                    <AlertDialogCancel onClick={() => setPasswords({ current: '', new: '', confirm: '' })}>
                      Batal
                    </AlertDialogCancel>
          ...
          <SecurityRow
            ...
            action={<Toggle on={twoFactor} onToggle={() => setTwoFactor(!twoFactor)} />}
          />
      ...
      <section>
        ...
        <div className="rounded-2xl border border-border divide-y divide-border overflow-hidden">
          <button
            ...
            onClick={() => { }}
          >
            <span className="text-[14px] text-amber-500 font-medium">Nonaktifkan Akun</span>
          </button>
          <AlertDialog>
            <AlertDialogTrigger asChild>
              <button className="w-full flex items-center px-4 py-3.5 hover:bg-muted/30 dark:hover:bg-white/[0.03] transition-colors text-left">
                <span className="text-[14px] text-red-500 font-medium">Hapus Akun</span>
              </button>
            </AlertDialogTrigger>
            <AlertDialogContent>
              <AlertDialogHeader>
