...
export const MOCK_PROFILE_POSTS: Post[] = [
  {
    ...
    caption: 'Morning light hits different at 5am in the Scottish Highlands. Worth every cold step. 🏔️',
  ...
  },
  {
    id: 'pp-2',
    user_id: 'jack-harding',
    caption: 'Hot take: the best travel photos aren\'t taken at tourist spots. They\'re taken at 6am when everyone else is still sleeping and the world is yours alone.',
  ...
  },
  {
    id: 'pp-6',
    user_id: 'jack-harding',
    caption: 'Gear doesn\'t make the photo. I shot some of my favourite frames on a 10-year-old kit lens. Stop waiting for the perfect camera body. Go outside.',
  ...
  },
  {
    id: 'pp-8',
    user_id: 'jack-harding',
    caption: 'Some thoughts on editing: less is more, always. If you\'re spending 45 minutes on a single raw file, you\'re probably going in the wrong direction. The best edits are invisible.',
  ...
  },
  {
    id: 'pp-10',
    user_id: 'jack-harding',
    caption: 'Open to brand collaborations in 2025. DM me or reach out at hello@jackharding.photo. Looking for outdoor, travel, and lifestyle work specifically. No crypto or finance please.',
  ...
  },
  {
    ...
    caption: 'The one that almost got away. Caught this light for maybe 90 seconds before it was gone.',
  ...
  },
  {
    id: 'pp-12',
    user_id: 'jack-harding',
    caption: 'Reminder: your follower count doesn\'t determine the quality of your work. Some of the best photographers I know have under 2k followers. Keep shooting.',
