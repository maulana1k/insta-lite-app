      ...
      <div className="flex-1 relative flex items-end justify-end group">
        <div
          className={cn(
            ...
            aspectRatio === "square"
              ? "aspect-square  max-h-[75dvh]"
              : "aspect-4/5 max-h-[75dvh]",
          )}
        >
          {imageSrc && (
            <img
        ...
        <div className=" pb-4">
            ...
            <div className="flex items-center gap-8 pt-2 overflow-x-auto px-8 scrollbar-hide">
              {EDIT_TOOLS.map((tool) => (
                <button
                  key={tool.id}
                  onClick={() =>
                    tool.min !== undefined ? setActiveTool(tool.id) : null
                  }
          ...
          {activeTab === "edit" && activeTool && (
            <div className="px-8 pt-3 max-w-md mx-auto">
              ...
              <Slider
                value={[
                  adjustments[activeTool as keyof typeof adjustments] || 100,
                ]}
              ...
              <div className="text-center">
                <span className="text-xs text-gray-500 font-mono">
                  {adjustments[activeTool as keyof typeof adjustments]}
                </span>
              </div>
            </div>
          )}
