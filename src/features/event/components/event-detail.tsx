      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-10">
        ...
        <div className="lg:w-lg shrink-0 space-y-6">
          ...
          <div>
            ...
            <div className="flex -space-x-2">
              {Array.from({ length: Math.min(6, event.attendees_count) }).map(
                (_, i) => (
                  <img
                    key={i}
        ...
        <div className="flex-1 min-w-0 space-y-6">
          ...
          {space && (
            <Link
              href="/"
              className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-muted/60 hover:bg-muted transition-colors"
            >
              <img
          ...
          <div className="flex items-start gap-4">
            <div className="size-12 rounded-xl bg-muted/60 border border-border flex items-center justify-center shrink-0">
              {isOnline ? (
                ...
                <MapPoint className="size-5 text-muted-foreground" />
              )}
            </div>
