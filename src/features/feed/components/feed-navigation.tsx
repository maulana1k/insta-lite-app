  ...
  return (
    <div className="fixed h-screen flex flex-col left-8 justify-center z-10 gap-2">
      <button
        ...
        className={cn("p-4 transition-opacity", mode === 'visual' ? "opacity-100 text-foreground" : "opacity-30 hover:opacity-100")}
        title="Visual Feed"
      >
        <Camera size={32} />
      </button>
      <button
        ...
        className={cn("p-4 transition-opacity", mode === 'text' ? "opacity-100 text-foreground" : "opacity-30 hover:opacity-100")}
        title="Text Feed"
      >
        <Notes size={32} />
      </button>
  ...
  return (
    <div className="fixed h-screen flex flex-col right-8 justify-center z-10">
      <button
        ...
        className={cn("p-4 transition-opacity", layout === 'grid3' ? "opacity-100 text-foreground" : "opacity-30 hover:opacity-100")}
        title="Grid View (3x3)"
      >
        <Grid3X3 size={26} />
      </button>
      <button
        ...
        className={cn("p-4 transition-opacity", layout === 'grid2' ? "opacity-100 text-foreground" : "opacity-30 hover:opacity-100")}
      ...
      <button
        ...
        className={cn("p-4 transition-opacity", layout === 'list' ? "opacity-100 text-foreground" : "opacity-30 hover:opacity-100")}
        title="List View"
      >
