...
import type { Activity, ActivityTab } from "../types";
...
export function useActivityFilter(
  ...
  return useMemo(() => {
    ...
    if (activeTab === "follows")
      return activities.filter((a) => a.type === "follow");
    if (activeTab === "mentions")
      return activities.filter((a) => a.type === "mention");
    if (activeTab === "likes")
      return activities.filter((a) => a.type === "like");
