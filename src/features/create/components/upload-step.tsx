...
import { Camera, ClapperboardPlay, GalleryAdd, LinkMinimalistic2, Notes } from '@solar-icons/react';
import { X, AlignLeft, Layers, MoreHorizontal, Smile, FileText, MapPin, ChevronRight } from 'lucide-react';
        ...
        {postType === 'media' ? (
          <div className="relative aspect-video border-2 border-dashed border-gray-300 rounded-2xl flex flex-col items-center justify-center gap-4 hover:bg-gray-50 transition-colors cursor-pointer group">
            ...
            <div className="text-center">
              <h3 className="text-xl font-base mb-1">Drag photos or videos here</h3>
                 ...
                 <div className="flex gap-3">
                    ...
                    <div className="flex flex-col items-center w-10 shrink-0">
                         ...
                         <div className="size-5 rounded-full bg-gray-200 shrink-0 z-20">
                             <img src="https://github.com/shadcn.png" alt="user" className="w-full h-full object-cover opacity-50 rounded-full" />
                         </div>
                    </div>
                    ...
                    <div className="flex-1 flex flex-col pb-4">
                         ...
                         <div className="flex items-center gap-1 mb-1">
                             <span className="font-semibold text-base leading-none">shadcn</span>
                         ...
                         {textAttachments.length > 0 && (
                            <div className="flex gap-2 overflow-x-auto pb-3 scrollbar-hide mb-1">
                                ...
                                <div key={index} className={cn("relative max-w-[500px] aspect-auto shrink-0 rounded-lg overflow-hidden border border-gray-200 group", textAttachments.length > 1 ? "max-h-[300px]" : "max-h-[500px]")}>
                                    <img
                         ...
                         <div className="flex items-center gap-4 my-2 text-gray-400">
                             <button className="relative hover:text-black transition-colors">
                                ...
                                <input
                                    ...
                                    onChange={(e) => {
                                        if (e.target.files) {
                                            Array.from(e.target.files).forEach(file => addTextAttachment(file));
                                        }
                                    }}
                                />
                             </button>
                             <button className="hover:text-black transition-colors"><Smile size={24} className="stroke-[1.5]" /></button>
                             <button className="hover:text-black transition-colors"><LinkMinimalistic2 size={24} className="stroke-[1.5]" /></button>
                             <button className="hover:text-black transition-colors"><AlignLeft size={24} className="stroke-[1.5]" /></button>
                             <button className="hover:text-black transition-colors"><MapPin size={24} className="stroke-[1.5]" /></button>
                         </div>
                    </div>
                 </div>
