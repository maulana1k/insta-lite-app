  ...
  return (
    ...
    >
      <div className="w-full max-w-[420px] flex flex-col gap-7">
        ...
        {/* Heading */}
        <div>
          <h1 className="text-[36px] font-black leading-tight tracking-tight">Make it yours.</h1>
          <p className="text-muted-foreground mt-1 text-[14px]">Tell people a little about yourself.</p>
        </div>
        ...
        <div className="flex items-center gap-5">
          ...
          <div>
            ...
            <p className="text-[12px] text-muted-foreground/60 mt-0.5">Click to upload · Optional</p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-[11px] font-semibold uppercase tracking-wider text-muted-foreground">
            Bio <span className="normal-case font-normal text-muted-foreground/50">· Optional</span>
          </label>
          <textarea
            value={form.bio}
